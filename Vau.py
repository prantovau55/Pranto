...
\033[1;32m[-] AUTHOR    :\033[1;32m pranto
\033[1;32m[-] GITHUB    :\033[1;32mprantovau_55
\033[1;32m[-] FACEBOOK  :\033[1;32m pranto
...
rp= 'ptanto vau'
x = '999+'
if 'pranto vau'==user and '999+'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL JOIN MY FACEBOOK ID")
	os.system('xdg-open https://www.facebook.com/profile.php?id=100080861812614')
else:
	Axak(y+"\n\n\t\t      Invalid User Or Pass")
	Axak(y+"\n\n\t\tContract Admin For User And Pass")
	os.system("xdg-open https://wa.me/+8801733789661")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥😈PRANTO VAI😈🔥  "+w+tim)
	resp3 = requests.post(url3, headers=headers3, data=data3)
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥😈PRANTO VAU😈🔥 "+w+tim)
